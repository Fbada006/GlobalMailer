...
import com.droidafricana.globalmail.viewModel.technology.TechnologyViewModel
import com.droidafricana.globalmail.viewModel.technology.TechnologyViewModelFactory
...
class TechnologyNewsFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private lateinit var mTechViewModel: TechnologyViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val articleViewModelFactory = TechnologyViewModelFactory(this.activity?.application!!,
                PrefUtils.categoryTech(context!!))

        mTechViewModel = ViewModelProviders.of(this, articleViewModelFactory).get(TechnologyViewModel::class.java)
