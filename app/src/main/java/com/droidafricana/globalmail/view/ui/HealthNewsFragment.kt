...
import com.droidafricana.globalmail.viewModel.health.HealthViewModel
import com.droidafricana.globalmail.viewModel.health.HealthViewModelFactory
...
class HealthNewsFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private lateinit var mHealthViewModel: HealthViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val articleViewModelFactory = HealthViewModelFactory(this.activity?.application!!,
                PrefUtils.categoryHealth(context!!))

        mHealthViewModel = ViewModelProviders.of(this, articleViewModelFactory).get(HealthViewModel::class.java)
        ...
        mHealthViewModel.healthArticlesFromDb.observe(this, Observer {
            if (it != null) {
    ...
    override fun onRefresh() {
        ...
        FragmentUtils.observeForArticlesFromDb(this, mHealthViewModel.healthArticlesFromDb
                , mMyArticleAdapter)
