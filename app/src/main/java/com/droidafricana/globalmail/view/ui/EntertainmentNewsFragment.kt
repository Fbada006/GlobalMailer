...
import com.droidafricana.globalmail.viewModel.entertainment.EntertainmentViewModel
import com.droidafricana.globalmail.viewModel.entertainment.EntertainmentViewModelFactory
...
class EntertainmentNewsFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private lateinit var mEntViewModel: EntertainmentViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.my_ent_news_fragment, container, false)
        ...
        val articleViewModelFactory = EntertainmentViewModelFactory(this.activity?.application!!,
                PrefUtils.categoryEnt(context!!))

        mEntViewModel = ViewModelProviders.of(this, articleViewModelFactory).get(EntertainmentViewModel::class.java)
        ...
        binding.entFragmentViewModel = mEntViewModel
