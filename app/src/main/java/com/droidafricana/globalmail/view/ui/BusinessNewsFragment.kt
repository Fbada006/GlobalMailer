...
import com.droidafricana.globalmail.viewModel.business.BusinessViewModel
import com.droidafricana.globalmail.viewModel.business.BusinessViewModelFactory
...
class BusinessNewsFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private lateinit var mBusViewModel: BusinessViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val articleViewModelFactory = BusinessViewModelFactory(this.activity?.application!!,
                PrefUtils.categoryBus(context!!))

        mBusViewModel = ViewModelProviders.of(this, articleViewModelFactory).get(BusinessViewModel::class.java)
