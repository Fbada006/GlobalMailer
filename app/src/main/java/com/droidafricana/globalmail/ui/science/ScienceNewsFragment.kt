...
class ScienceNewsFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private val mScienceViewModel by viewModels<ScienceViewModel> {
        getArticleViewModelFactory(PrefUtils.categoryScience(requireContext()))
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mScienceViewModel.scienceArticlesFromDb.observe(viewLifecycleOwner, {
            if (it != null) {
